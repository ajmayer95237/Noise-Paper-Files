...
CV_i = [];
m_burst_average = i;
km = gamma_m*mean_ms/m_burst_average;
...
plot(x,1/target_p+gamma_p*x./(gamma_p*mean_as+(gamma_p+gamma_m)*mean_ms),'--')
...
xlabel('$\langle B \rangle$','Interpreter','latex')
