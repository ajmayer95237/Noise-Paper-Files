...
for i = 1:50   
    sigma = sqrt(2*theta*mu^2*CV_2_mpt);
    ...
    CV_2_mpt = CV_2_mpt+.01;
end

CVmpts = .01:.01:.5

plot(CVmpts,CV_squareds,'r--o')
hold on
plot(CVmpts,(gamma_p/(gamma_p+theta))*CVmpts,'b')
plot(CVmpts,(1/2000+1/(1+.5/.2))*ones(50,1),'--g')
xlabel('$CV^2(m_{pt})$','interpreter','latex')
